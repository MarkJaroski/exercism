defmodule AllYourBase do
  ...
  def to_integer(digits, input_base) do
    digits
    |> Enum.reverse
    |> Enum.with_index(0)
  ...
  def to_digits(int, output_base, acc \\ [])
  def to_digits(0, _, []), do: [0]
  def to_digits(0, _, acc), do: acc
  def to_digits(int, output_base, acc) do
